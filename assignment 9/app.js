...
let  Month1 = new Date()
let ar = ["january","fabuary","march","april","may","june","july","august","september","octuber","november","december"]
let currentMonth = ar[Month1.getMonth()];

let numberUnit = 653
let charge = 12

let NetAmount = numberUnit * charge

let late = 450
 
let after = NetAmount + late 

document.writeln("<h1>"+ "K-Elactric Bill" + "</h1>"+"<br>")

document.writeln("Customer Name : " + cusName + "<br>")
document.writeln("Month : " + currentMonth + "<br>")
document.writeln("Number of unit : " + numberUnit + "<br>")
document.writeln("Charges per unit : " + charge + "<br>"+"<br>")
document.writeln("Net Amount payable (within Due Date): " + NetAmount + "<br>")
document.writeln("Late payment surcharge : " + late + "<br>" )
document.writeln("Gross Amount payable (after Due Date): " + after + "<br>")